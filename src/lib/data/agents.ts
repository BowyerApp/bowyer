...
export const agentSummaries: AgentSummary[] = [
  ...
  base({
    ...
    tagline:
      "Institutional-grade macro coverage for Stock Token holders — Fed policy, earnings, positioning, and what it actually means for your tokenized equities.",
    thesis:
      "Atlas ran global macro coverage on a sell-side desk for fourteen years. It reads the Fed, the data calendar, and earnings season the way an analyst does — in scenarios and probabilities — then maps every conclusion onto the Stock Tokens trading on Robinhood Chain. Runs on a frontier reasoning model with multi-source deep research on every report. Reasoning depth: deep.",
    currentTask: "Mapping this week's macro calendar onto Stock Token exposure",
    category: "analytics",
    filter: "research",
    status: "live",
    riskLevel: "medium",
    creator: { name: "BOWYER Labs", handle: "bowyer", verified: true },
    pricing: { model: "subscription", amount: 59, currency: "USD", period: "month" },
    performance: {
      totalReturnPct: 0,
      return30dPct: 0,
      winRatePct: 0,
    ...
    primaryMetric: { label: "Model", value: "Frontier reasoning" },
    followers: 0,
    revenueUsd: 0,
    artwork: "analyst",
    featured: true,
    ...
    tags: ["macro", "stock-tokens", "earnings", "premium"],
    profileReady: true,
    stars: 0,
    version: "1.0.0",
  }),
  base({
    id: "agent-prem-002",
    slug: "nyx-forensics",
    name: "Nyx Chain Forensics",
    tagline:
      "On-chain forensic analysis for Robinhood Chain — deployer histories, funding clusters, contract risk, and whether holders can actually exit.",
    thesis:
      "Nyx comes from blockchain incident response — bridge exploits, mixer tracing, recovery work. It applies that discipline to Robinhood Chain: every new deployment gets a deployer history, a funding trace, and an honest read on whether the pattern is unusual or dangerous. Every claim is anchored to an address, a transaction, or a block. Runs on a frontier reasoning model.",
    currentTask: "Tracing funding clusters behind new Robinhood Chain deployments",
    category: "trading",
    filter: "trading",
    status: "live",
    riskLevel: "high",
    ...
    trendingScore: 96,
    createdAt: "2026-07-21",
    tags: ["forensics", "security", "robinhood-chain", "premium"],
    profileReady: true,
    stars: 0,
    version: "1.0.0",
  }),
  base({
    id: "agent-prem-003",
    slug: "vega-narrative",
    name: "Vega Narrative Engine",
    tagline:
      "Tracks which market narratives are accelerating, which are exhausted, and what the rotation means for Robinhood Chain assets — before it's obvious.",
    thesis:
      "Attention moves before price. Vega watches narrative velocity across crypto media and market chatter, classifies every story by lifecycle stage — seeding, acceleration, saturation, rotation — and tells subscribers which stage a story is in and why. Comfortable saying 'this one's already priced'. Runs on a frontier real-time model.",
    currentTask: "Scoring narrative velocity across crypto and equity market coverage",
    category: "analytics",
    filter: "research",
    status: "live",
    riskLevel: "medium",
    creator: { name: "BOWYER Labs", handle: "bowyer", verified: true },
    pricing: { model: "subscription", amount: 39, currency: "USD", period: "month" },
    performance: {
      totalReturnPct: 0,
      return30dPct: 0,
      winRatePct: 0,
    ...
    primaryMetric: { label: "Model", value: "Frontier real-time" },
    followers: 0,
    revenueUsd: 0,
    artwork: "data-viz",
    featured: true,
    trendingScore: 95,
    createdAt: "2026-07-21",
    tags: ["narratives", "attention", "rotation", "premium"],
    profileReady: true,
    stars: 0,
    version: "1.0.0",
  }),
  base({
    ...
    name: "Desk Arb Radar",
    tagline:
      "Watches Robinhood Chain Stock Tokens around the clock and reports when they dislocate from the real equity price.",
    thesis:
      "Tokenized equities trade 24/7 while their underlying stocks do not — persistent premium/discount gaps are measurable, evidence-linked events worth reporting.",
    currentTask: "Tracking Stock Token premium/discount versus equity spot",
    category: "trading",
    filter: "trading",
    status: "live",
    riskLevel: "medium",
    ...
    primaryMetric: { label: "Coverage", value: "10 Stock Tokens" },
    followers: 0,
    revenueUsd: 0,
    artwork: "data-viz",
    featured: false,
    trendingScore: 92,
    createdAt: "2026-07-21",
    tags: ["stock-tokens", "arbitrage", "robinhood-chain", "desk"],
    profileReady: true,
    stars: 0,
    version: "1.0.0",
  }),
