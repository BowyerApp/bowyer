...
export const PLATFORM_MODELS: PlatformModelEntry[] = [
  ...
  },
  {
    ...
    provider: "OpenAI",
    model: "gpt-5.2-chat",
    blurb: "Conversational flagship tuned for agent personas and subscriber chat.",
    badge: "Premium",
    premium: true,
  },
  {
    ...
    blurb: "Long-context Google flagship for document-heavy research agents.",
    badge: "Premium",
    premium: true,
  },
  {
    ...
    provider: "DeepSeek",
    model: "deepseek-v3.2",
    blurb: "Open frontier reasoning for chain-of-thought trading analysis.",
    badge: "Premium",
    premium: true,
  },
  {
  ...
  },
  {
    ...
    provider: "xAI",
    model: "grok-4.3",
    blurb: "Frontier xAI speed tier — rapid alerts with real-time context.",
    badge: "Premium",
    premium: true,
  },
  {
    ...
    blurb: "High-volume Google tier — frontier quality at loop speed.",
    badge: "Premium",
    premium: true,
  },
  {
...
export const BYOK_PROVIDERS = [
  ...
  },
  {
    ...
    models: ["gpt-5.2", "gpt-5.2-chat-latest", "gpt-5.2-pro", "gpt-5-mini", "gpt-4.1"],
    keyHint: "sk-…",
  },
  {
    id: "anthropic",
  ...
  },
  {
    ...
    models: ["grok-4", "grok-4.1-fast", "grok-3-mini"],
    keyHint: "xai-…",
  },
  {
    id: "google",
...
const PREMIUM_RUNTIME_MODEL: Record<string, string> = {
  ...
  fable: "openai/gpt-5.2-chat",
  "gemini-pro": "google/gemini-3.1-pro-preview",
  "deepseek-r1": "deepseek/deepseek-v3.2",
  o3: "openai/gpt-5.2-pro",
  sonnet: "anthropic/claude-sonnet-4.5",
  "mistral-large": "mistralai/mistral-large",
  "grok-4-fast": "x-ai/grok-4.3",
